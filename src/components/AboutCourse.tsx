...
function AboutCourse() {
  return (
    <div className='py-10 px-52 flex flex-col bg-[#0F3941] text-white font-aladin items-center justify-around gap-20'>
        ...
        <div className='flex justify-around px-52 gap-5'>
