...
const tips = [
  { name: "Paro Shetty", avatar: "/person1.png", tip: "Confidence. It's essential to project confidence in your abilities and responses", bg: "" },
  { name: "Rakesh Kumar", avatar: "/person2.png", tip: "How can I effectively prepare for common interview questions?", bg: "bg-white" },
  { name: "Paro Shetty", avatar: "/person1.png", tip: "Research typical questions, practice responses, and focus on highlighting relevant experiences.", bg: "" },
  { name: "Rakesh Kumar", avatar: "/person2.png", tip: "Any tips for making a lasting impression on the interviewer?", bg: "bg-white" },
  { name: "Andy Bert", avatar: "/person1.png", tip: "Be authentic, engage actively, and demonstrate your enthusiasm for the role and company.", bg: "" },
...
function TipBox({ data, className }: { data: { name: string, tip: string, avatar: string, bg: string }; className?: string }) {
  ...
  return <div className={cn("flex gap-6 p-5 rounded-[1.5rem] border border-black hover:bg-violet-600 hover:text-white", className, textClass, data.bg)}>
